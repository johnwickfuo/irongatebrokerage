...
} elseif ($_instance->childHasBeenRendered('QQpajiY')) {
    $componentId = $_instance->getRenderedChildComponentId('QQpajiY');
    $componentTag = $_instance->getRenderedChildComponentTagName('QQpajiY');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('QQpajiY');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('QQpajiY', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/assethub.live/public_html/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>