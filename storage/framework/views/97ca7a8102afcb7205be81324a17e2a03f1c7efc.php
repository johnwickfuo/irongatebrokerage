                            ...
                            <?php else: ?>
                                <button type="button"
                                    ...
                                    <span class="flex items-center justify-center gap-2">
                                        ...
                                        Start Copying ($<?php echo e(number_format((float)$expert->price, 2)); ?>)
                                    </span>
                                </button>
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/assethub.live/public_html/resources/views/user/copy/experts.blade.php ENDPATH**/ ?>