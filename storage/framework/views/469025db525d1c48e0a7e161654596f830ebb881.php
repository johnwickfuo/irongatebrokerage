        ...
        <?php if(Session::has('status')): ?>
            <div class="p-4 bg-green-500/10 border border-green-500/20 rounded-xl">
                <div class="flex items-center gap-3">
                    ...
                    <p class="text-green-300 text-sm font-bold"><?php echo e(session('status')); ?></p>
                </div>
            </div>
        <?php endif; ?>
        ...
        <?php if(Session::has('message')): ?>
            <div class="p-4 bg-blue-500/10 border border-blue-500/20 rounded-xl">
                <div class="flex items-center gap-3">
                    ...
                    <p class="text-blue-300 text-sm font-bold"><?php echo e(Session::get('message')); ?></p>
                </div>
            </div>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.guest1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/assethub.live/public_html/resources/views/auth/reset-password.blade.php ENDPATH**/ ?>